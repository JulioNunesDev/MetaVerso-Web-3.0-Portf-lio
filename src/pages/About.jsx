import { Card, Content } from "../styles/styAbout";
...
function About (){
    ...
    <div class="user-picture">
        <img src={julio} alt="Julio author" />
    </div>
    <p class="name-client"> Julio Nunes
        <span>FullStack Junior
        </span>
    </p>
    <div class="social-media">
        <a href="https://julionunes.vercel.app/" target='_blank'>
